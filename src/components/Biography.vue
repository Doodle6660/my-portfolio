                ...
                <div class="flex flex-col w-1/2 md:w-1/4 text-white gap-6">
                    ...
                    <div class="flex flex-row items-center space-x-2">
                        <svg
                            ...
                            class="w-4 xl:w-8 h-4 xl:h-8 fill-current text-white"
                        >
                            <g>
                                <path
                    ...
                    <div class="flex flex-row items-center space-x-2">
                        <svg
                            ...
                            viewBox="0 0 512 512"
                            xml:space="preserve"
                            class="w-4 md:w-8 h-4 md:h-8 fill-current text-white"
                        >
                            <g>
                                <g>
                                    <path
			...
			C0,225.563,158.438,384,353.188,384c16.99,0,30.813-13.823,30.813-30.813v-70.323C384,265.875,370.177,252.052,353.188,252.052z"
                    ...
                    <div class="flex flex-row items-center space-x-2">
                        <svg
                            ...
                            width="512"
                            xmlns="http://www.w3.org/2000/svg"
                            class="w-4 md:w-8 w-4 md:h-8 fill-current text-white"
                        >
                            <g>
                                <path
                ...
                <div class="flex flex-col w-1/2 md:w-3/4 text-white gap-6">
                    ...
                    <p class="text-lg">
                        ...
                        mah art work if you're interested, and I'd love it if
                        you did.
                    </p>
                </div>
            </div>
